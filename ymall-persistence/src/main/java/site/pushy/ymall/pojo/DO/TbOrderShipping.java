...
public class TbOrderShipping {
    ...
    public TbOrderShipping(Long orderId, OrderInfo orderInfo) {
        this.setOrderId(String.valueOf(orderId));
        this.setReceiverName(orderInfo.getUserName());
        this.setReceiverAddress(orderInfo.getStreetName());
        this.setReceiverPhone(orderInfo.getTel());
        this.setCreated(new Date());
        this.setUpdated(new Date());
    }

    public TbOrderShipping(Long orderId, SeckillOrderInfo orderInfo) {
        this.setOrderId(String.valueOf(orderId));
        this.setReceiverName(orderInfo.getUserName());
        this.setReceiverAddress(orderInfo.getStreetName());
        this.setReceiverPhone(orderInfo.getTel());
